...
.nav-body > :first-child {
  background:
    ...
    /* Top Cover */ linear-gradient(rgba(0, 0, 0, 0), var(--cl-bg) 70%) center bottom,
    /* Bottom Cover */ linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0)) center top,
    /* Top Shadow */ linear-gradient(rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.5)) center bottom; /* Bottom Shadow */
