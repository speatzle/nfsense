...
let $addresses = [] as any[]; // TODO: Add proper type
let $loading = false;
const $selection = [] as number[];

const addressValueDefinition: { [key: string]: { path: string; component?: Component } } = {
...
async function deleteAddress() {
  ...
  if (res.Error === null) console.debug("deleted address");
  else console.debug("error", res);
